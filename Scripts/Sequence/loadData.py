...
def setup_riders_info(scenario, rider_info, parameters):
    #p = np.array([0.03, 0.05, 0.10, 0.15, 0.30, 0.15, 0.10, 0.05, 0.04, 0.03])
    ...
    #order_rewards = range(rider_info['LB_reward'], rider_info['UB_reward'] + 20, 20)
    ...
    while temp_time_r < scenario['T']:
        ...
        #p = np.array([0.01, 0.01, 0.02, 0.04, 0.06, 0.08, 0.09, 0.10, 0.49, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01])
...
def setup_drivers_info(scenario, driver_info, parameters):           
    ...
    while temp_time_d < scenario['T']:
        ...
        #p_1 = np.array([1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9])
...
def setup_arriving_list(scenario):
    arriving_list = {} #arriving_list[index]={[index, 'Rider'or'Driver', 'pos_i'or'pos_j', 'arrival_time']}
    pos_i = 1
    pos_j = 1
    index = 1
...
if __name__ == '__main__':
    ...
    dict_dataLoader = load_data("C:/Users/RDL/Desktop/dynamic simulation/45s/")
