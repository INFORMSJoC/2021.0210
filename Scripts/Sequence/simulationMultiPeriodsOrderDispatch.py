...
import dispatch_control_flow,dispatch_control_flow_I

N_simulations = 50

if __name__ == '__main__':
    # Load the data
    data_dir = "C:/Users/RDL/Desktop/dynamic simulation/45s/"
    ...
    for setting in list(zip(list_parameters, list_riders, list_drivers)):
        for i in range(0, N_simulations):    
            ...
            #dispatch_control_flow.run_simulation("III", data_dir, scenario = scenario.copy())     
            dispatch_control_flow.run_simulation("III_revised", data_dir, scenario = scenario.copy())            
            #dispatch_control_flow_I.run_simulation("V", data_dir, scenario = scenario.copy())            
